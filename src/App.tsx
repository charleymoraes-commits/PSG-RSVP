  ...
  return (
    <div style={{ background: 'black', color: 'white', minHeight: '100vh', padding: '40px', fontFamily: 'sans-serif' }}>
      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <h1 style={{ fontStyle: 'italic', fontWeight: '900', fontSize: '2.5rem' }}>PSG PERTH</h1>
        {session && (
      ...
      <div style={{ marginTop: '100px', textAlign: 'center', border: '1px solid #333', padding: '60px', borderRadius: '24px' }}>
        <Trophy size={64} color="#00ff66" style={{ marginBottom: '20px' }} />
        <h2>Match Centre Online</h2>
